...
down_file <- paste0("10X_single_cell/metascape_", "9.15_","down","/Enrichment_GO/_FINAL_GO.csv")
...
all_markers <- list()
all_markers[["LM2-CTC cluster"]] <- read.csv('files/an0013_lm2.sample2.3.merge.differentiation1/de.marker_LM2-CTC cluster.csv')
all_markers[["LM2-CTC Single"]] <- read.csv('files/an0013_lm2.sample2.3.merge.differentiation1/de.marker_LM2-CTC Single.csv')
all_markers[["LM2-Lung Metastasis"]] <- read.csv('files/an0013_lm2.sample2.3.merge.differentiation1/de.marker_LM2-Lung Metastasis.csv')
all_markers[["LM2-Primary tumor"]] <-  read.csv('files/an0013_lm2.sample2.3.merge.differentiation1/de.marker_LM2-Primary tumor.csv')
